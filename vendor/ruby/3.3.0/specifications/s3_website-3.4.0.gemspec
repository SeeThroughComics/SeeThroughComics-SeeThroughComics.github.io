...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<thor>.freeze, ["~> 0.18".freeze])
  s.add_runtime_dependency(%q<configure-s3-website>.freeze, ["= 2.3.0".freeze])
  s.add_runtime_dependency(%q<colored>.freeze, ["= 1.2".freeze])
  s.add_runtime_dependency(%q<dotenv>.freeze, ["~> 1.0".freeze])
  s.add_development_dependency(%q<rake>.freeze, ["= 10.1.1".freeze])
  s.add_development_dependency(%q<octokit>.freeze, ["= 3.1.0".freeze])
