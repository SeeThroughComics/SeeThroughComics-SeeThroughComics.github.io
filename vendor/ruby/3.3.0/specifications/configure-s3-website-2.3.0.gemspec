...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<deep_merge>.freeze, ["~> 1.0.0".freeze])
  s.add_runtime_dependency(%q<aws-sdk>.freeze, ["~> 2".freeze])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3".freeze])
  s.add_development_dependency(%q<rspec-expectations>.freeze, ["~> 3".freeze])
